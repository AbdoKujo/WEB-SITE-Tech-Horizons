...
<div class="container" style="margin-top:30px">
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 30px;">
        <h1 style="margin: 0; font-size: 1.5rem; font-weight: bold; color: #111827;">{{ $theme->name }}</h1>
    </div>

    <h6 style="margin-bottom:30px">This theme features the most popular articles on Tech Horizons. Dive in to explore trending topics!</h6>
